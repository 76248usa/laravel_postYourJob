...
<body>
  ...
  <div class="container">
    ...
    <h1 class="display-4">Search applicants</h1>
    <i class="fas fa-user-md fa-8x"></i>
    <p class="lead">Find the perfect person for the job. Fill out search below:</p>
       ...
       <table class="table table-striped table-bordered table-list">
        ...
        @foreach($details as $application)
          ...
          <td class="avatar"><img src="/images/{{$application->user->photo ? $application->user->photo->file : '1540743667Avatar2.png'}}" ></td> 
             ...
             <td>{{$application->skill_2}} </td>
             <td>{{str_limit($application->body, 45)}} </td>           
